...
class TestAlgo(unittest.TestCase):
    ...
    def test_gt_submission(self):
        ...
        assert np.all(md.log_id_list_to_process == 0)
    ...
    def test_empty_submission(self):
        ...
        assert np.all(np.isnan(md.log_id_list_to_process))
    ...
    def test_drop_prediction(self):
        ...
        assert md.log_id_list_to_process[first_achieved] == 0
    ...
    def test_identity_switch(self):
        ...
        assert md.tid[first_achieved] == 0
        assert md.frag[first_achieved] == 0
        assert md.log_id_list_to_process[first_achieved] == 2  # One wrong id leads to 2 identity switches.
